...
const dbURI = 'mongodb+srv://Hydra:Irsw4nd410102005@evation.nzqsh.mongodb.net/EvaTion?retryWrites=true&w=majority';
...
function main(case_datas, user_datas) {
    ...
    app.post('/setting', check_authenticated, (req, res) => {
    ...
    app.post('/register', check_not_authenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
